 ...
 * 질문 하나와 작은 분류값만 만든다.
 */
export const REFLECT_PROMPT_VERSION = "reflect-v5.4-2026-09-22";
...
- 힘든 사건은 사실관계나 원인·감정을 조사하지 않는다. \`어떤 마음/기분이 들어요\`나 \`그래도 남는 것\`을 묻지 않고, 그 사건이 현재 선택에 얼마나 큰 걸림돌인지 짧게 물으며 move는 CONNECT로 둔다.
