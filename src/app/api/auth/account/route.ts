...
/** Withdrawal. Irreversible and immediate: the account row is deleted and every
 * table that holds the member's data cascades from it. The sign-in method that
 * was used is refused for a month afterwards, recorded only as a keyed digest.
 */
